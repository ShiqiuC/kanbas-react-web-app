  ...
  return (
    <>
      <div id="wd-css-styling-forms">
        <h2 className="wd-select-text">Forms</h2>
        <div className="mb-3">
      ...
      <div id="wd-css-styling-dropdowns">
        <h3 className="wd-select-text">Dropdowns</h3>
      ...
      <div id="wd-css-styling-switches">
        <h3 className="wd-select-text">Switches</h3>
      ...
      <div id="wd-css-styling-range-and-sliders">
        <h3 className="wd-select-text">Range</h3>
      ...
      <div id="wd-css-styling-addons">
        <h3 className="wd-select-text">Addons</h3>
      ...
      <div id="wd-css-responsive-forms-1">
        <h3 className="wd-select-text">Responsive forms</h3>
