export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-images">
        <h4>Image tag</h4>
        Loading an image from internet:
        <br />
        <img
          id="wd-starship"
          width="400px"
      ...
      <br />
      Please
      <a id="wd-github" href="https://github.com/ShiqiuC/kanbas-react-web-app">
        click here
      </a>
      to get my github repo
    </div>
  );
}
